...
function hoverToggleRevealCard(bool) {
  if (bool) {
    (0, _jquery2.default)('.card-reveal-wrapper').hover(function () {
      (0, _jquery2.default)(this).find('.card-reveal').toggleClass('open');
    });
  }
}
...
!function () {
  ...
  (0, _jquery2.default)('a[href="' + pgurl + '"]').parent().addClass('active');
}();

// Open / Close Reveal Hover on large screens
var largeScreen = _foundationSites2.default.MediaQuery.atLeast('large');
...
(0, _jquery2.default)(window).on('changed.zf.mediaquery', function (event, newSize, oldSize) {
  if ((oldSize == 'small' || oldSize == 'medium') && newSize == 'large') {
    ...
    largeScreen = _foundationSites2.default.MediaQuery.atLeast('large');
...
(0, _jquery2.default)('.card-section').click(function () {
  if (!largeScreen) {
    (0, _jquery2.default)(this).parent().parent().find('.card-reveal').toggleClass('open');
  }
});

// Close Card Reveal Click
(0, _jquery2.default)('.close-button').click(function () {
  if (!largeScreen) {
    (0, _jquery2.default)(this).parent().find('.card-reveal').toggleClass('open');
  }
});
...
(0, _jquery2.default)(window).scroll(function () {
  (0, _jquery2.default)("header").css({
    'opacity': 1 - (0, _jquery2.default)(this).scrollTop() / ((0, _jquery2.default)(window).height() * .85)
  });
});
...
var topNav = new Waypoint({
  ...
  handler: function handler() {
    (0, _jquery2.default)('#top-nav').toggleClass('hide');
  },
  offset: 10
});
